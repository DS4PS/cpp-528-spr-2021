...
The project for this course is designed as an opportunity to practice project management skills. It is broken into six steps, leaving one week at the end of the semester for a final round of revisions, documenting the process, and house-cleaning in your GitHub repo.
...
Each week you will work on one step of the analysis as a lab. These labs should be completed and submitted individually (you are still allowed to collaborate on labs but submit your labs individually). Your team can then synthesize a final chapter from components of team member files.

The group grade will primarily focus on the integration of content into a clean final report format that makes all of the steps in the process transparent and easily reproducible.
...
Your deliverable will be a report packaged as a Jekyll website hosted on GitHub, and all of the components necessary to replicate results (data, code, documentation of packages, etc).
...
### Project Website in Jekyll [15 points]

You will create an `index.md` file to serve as the landing page for the report, and link to report chapters from that document. Individual chapters should be stored as separate `RMD` files (rendered as `HTM`L files for the report). You can link to rendered `HTML` files by referencing them in the proper sub-directories:
...
### Analysis [15 points]
* Quality of models and presentation of the steps to produce results: o Chapteronmetrics
...
* GitHub Commits
    + Commits have useful names and clear descriptions 
        + Good example: `'Create .rds file that stores final predictive model'`
